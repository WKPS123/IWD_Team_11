...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-lg-9">
          ...
          >
            ...
            >
              ...
              <a class="btn btn-primary" style="margin-left: 150px;" href="logout.php">Logout</a>
            </div>
          </nav>
        </div>
      </div>
      ...
      <div class="container py-5">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7">
            ...
            StarRight offers an online learning platform that enables users to engage in comprehensive Dementia courses.
            </p>
            <a
              href="about.php"
      ...
      <div class="container pt-5 pb-3">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div
              class="cat-item position-relative overflow-hidden rounded" style="width: auto; height:88%;"
            >
              <img class="img-fluid" src="img/intro.jpg" alt="" />
              <a
                class="cat-overlay text-white text-decoration-none"
                href="chapter/Symptoms.php"
              >
                <h4 class="text-white font-weight-medium">Dementia Symptoms</h4>
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div
              class="cat-item position-relative overflow-hidden rounded mb-2" style="width: auto; height:88%;"
            >
              <img class="img-fluid" src="img/tips.jpg" alt="" />
              <a class="cat-overlay text-white text-decoration-none" href="chapter/communication.php">
                <h4 class="text-white font-weight-medium text-center">Tips for communicating with a person with Dementia</h4>
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4">
            <div
              class="cat-item position-relative overflow-hidden rounded mb-2" style="width: auto; height:88%;"
            >
              <img class="img-fluid" src="img/dealing.jpg" alt="" />
              <a class="cat-overlay text-white text-decoration-none" href="chapter/dealing.php">
                <h4 class="text-white font-weight-medium text-center">Dealing with the troubling behavior of a person with dementia</h4>
              </a>
            </div>
          </div>
        </div>
    ...
    <script src="update_progress.js"></script>
