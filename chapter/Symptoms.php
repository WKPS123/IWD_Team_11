    ...
    <div class="navbar-reading navbar-inverse">
          <div class="container" style="text-align: center;">
              <div class="navbar-header">
                  <h1 class="navbar-brand">Dementia Symptoms</h1>
              </div>
          </div>
      ...
      <div class="container sim">
            <div class="col-lg-10">
                ...
                <h3>Definition:</h3>
                <br>
                <p>Dementia is a broad term used to describe a group of progressive neurological disorders that affect cognitive functions such as memory, thinking, language, judgment, and behavior. It is not a specific disease but rather a syndrome resulting from various underlying conditions that lead to a decline in cognitive abilities beyond what is considered normal for aging.</p>
                <br>
                <h3>What are the signs and symptoms of dementia?</h3>
                <br>
                <p>Signs and symptoms of dementia result when once-healthy neurons (nerve cells) in the brain stop working, lose connections with other brain cells, and die. While everyone loses some neurons as they age, people with dementia experience far greater loss.</p>
                <br>
                <p>The signs and symptoms can vary depending on the type and may include:</p>
                <br>
                <ul>
                  <li>Experiencing a decline in memory retention, impaired judgment, and feelings of confusion.</li>
                  <li>Facing challenges in speaking, understanding, expressing thoughts, and reading or writing.</li>
                  <li>Wandering and getting lost in a familiar neighborhood.</li>
                  <li>Repeating inquiries or statements multiple times.</li>
                  <li>Using uncommon words to describe familiar objects.</li>
                  <li>Taking an extended time to accomplish routine daily tasks.</li>
                  <li>Losing interest in usual activities or events.</li>
                  <li>Having hallucinations or experiencing delusions or paranoia.</li>
                  <li>Demonstrating impulsive behavior.</li>
                  <li>Showing a lack of concern for others' emotions.</li>
                  <li>Experiencing difficulties with balance and movement.</li>
                </ul>
            </div>
      </div> <!-- /container -->
      <br><br>
      ...
      <form method="post" action="save_progress.php">
        <a class="btn btn-primary" style="margin-left: 10%;" href="../home.php">Back Home Page</a>
        <a class="btn btn-primary" style="margin-left: 30%;" href="quiz-symptoms.php">Quizz</a>
        <button class="btn btn-primary" style="margin-left: 30%; <?= $nextChapterButtonStyle ?>" id="nextChapterBtn" type="submit" name="next_chapter" value="1">Next Chapter</button>
      </form>
