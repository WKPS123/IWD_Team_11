...
quit_btn.onclick = () => {
  window.location.href = "dealing.php";
};
...
quit_quiz.onclick = () => {
  window.location.href = "../chapter/dealing.php";

  // Send the quiz result to the PHP file using AJAX
  const xhr = new XMLHttpRequest();
  const url = "../save_result.php";
  const params =
    "quiz_id=3&topic=Dealing with the troubling behavior of a person with dementia&score=" +
    userScore;
